      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <section className="overflow-hidden rounded-[36px] bg-gradient-to-r from-[#E96B8A] to-[#f18ca8] p-10 text-white">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center">
            ...
            <div className="flex-1">
              ...
              {hasAssessment && (
                <div className="mt-5 inline-flex rounded-full bg-white px-5 py-2 text-sm font-bold text-[#E96B8A]">
                  مسارك الحالي: {userPackage}
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              ...
              <div>
                ...
                <p className="mt-3 leading-7 font-normal text-gray-600">
                  أكملت التقييم بالفعل. يمكنك الآن الاستفادة من المصادر
                  المجانية والمسارات المقترحة لك.
                </p>
              </div>
        ...
        {hasAssessment && userPackage && (
          <section className="mt-8 overflow-hidden rounded-[36px] bg-gradient-to-r from-[#2A1520] via-[#4a2030] to-[#E96B8A] p-10 text-white">
            ...
            <Link
              ...
              className="mt-8 inline-flex rounded-xl bg-white px-8 py-4 font-bold text-[#2A1520] transition hover:bg-white/90"
            >
              التقديم الآن
            </Link>
        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-3">
          ...
          <div className="rounded-3xl bg-white p-8 shadow-sm">
            ...
            <div className="space-y-5 font-medium text-gray-700">
